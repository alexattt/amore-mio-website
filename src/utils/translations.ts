export const translations: any = {
  lv: {
    ...
    aboutUs:
      "Mūsu kompānija MIATA ir jauns apģērbu zīmols par pieņemamām cenām. Jauns, bet jau paspējis iegūt mūsu klientu uzticību. Mēs esam pārliecināti, ka ikviena sieviete iemīlēs mūsu izstrādājumus un jutīsies vēl labāka, pārliecinātāka un maigāka nēsājot tos.\nJūs vienmēr varat ar mums sazināties un būt pārliecināti, ka tiksiet uzklausīti.\nMēs mīlam to, ko darām priekš Jums, līdz ar to neredzam robežas mūsu attīstībai un uzlabojumiem.",
  ...
  en: {
    ...
    aboutUs:
      "Our company MIATA is a new brand of clothing with reasonable prices. Despite being new, we already have managed to earn trust and build good relationships with our clients. We are more than sure that every woman will love our products and will feel better and more delicate wearing them.\nYou can always contact us and be sure that you will be heard.\nWe love what we do for you, which means we do not set any boundaries for our development and improvement.",
  ...
  ru: {
    ...
    orderForm: {
      ...
      orderDenied:
        "Что то пошло не так. Пробуйте сново потом или свяжитесь с нами в соцсетях!",
    },
    orderFormValidation: {
    ...
    aboutUs:
      "Наша компания MIATA - это начинающий бренд одежды по приемлемым ценам. Начинающий , но уже успевший завоевать доверие и хорошие взаимоотношения с нашими клиентами. Мы уверены, что каждая девушка влюбится в наши изделия и почувствует себя в них ещё лучше и нежнее.\nВы всегда можете связаться с нами и быть уверенными, что мы вас услышим.\nМы любим то, что делаем для вас, а значит, не видит границ развития и улучшения.",
