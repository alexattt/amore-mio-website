        ...
        <Slider {...settings} arrows={size.width < 768 ? false : true} slidesToShow={1}>
          <div className='order-form-inputs'>
            <Form className='flex-column' 
              innerRef={orderFormRef} onSubmit={handleSubmit} 
            ...
            >
              ...
              {(contactType === "e-pastā" || contactType === "e-mail") && <FormGroup className='flex-column'>
                ...
                {emailInputError.showMsg && <FormFeedback style={{ fontSize: '12px', color: '#FF00FF', fontWeight: "700" }}>
                  {emailInputError.msg}
                </FormFeedback>}
              </FormGroup>}
              {(contactType.includes('WhatsApp')) && <FormGroup className='flex-column'>
                ...
                {phoneNumInputError.showMsg && <FormFeedback style={{ fontSize: '12px', color: '#FF00FF', fontWeight: "700" }}>
              ...
              {(contactType === "Instagram") && <FormGroup className='flex-column'>
                ...
                {usernameInputError.showMsg && <FormFeedback style={{ fontSize: '12px', color: '#FF00FF', fontWeight: "700" }}>
