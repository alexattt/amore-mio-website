  ...
  return (
    <div id="shop">
      ...
      <Slider
        ...
        fade={size.width < 1000 ? true : false}
        lazyLoad="progressive"
      >
        {robes.map((item: ShopItemModel, index: number) => {
          return <ShopItem key={index} itemData={item} language={language} />;
        })}
      </Slider>
      <br />
      <Slider
        ...
        lazyLoad="progressive"
      >
        {pyjamas.map((item: ShopItemModel, index: number) => {
          return <ShopItem key={index} itemData={item} language={language} />;
        })}
      </Slider>
    </div>
